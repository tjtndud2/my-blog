# 지금까지의 문제 상황
* 블로그 글을 하나 작성하기 위해 매번 반복하는 일
    * 글은 _posts 하위에 작성한다.
    * 파일 이름은 YYYY-MM-DD-영어제목.md 이여야한다.
...
:white_check_mark: 좋은 예: "서버 상태와 클라이언트 상태를 분리하기 위해 React Query를 도입했다. 기존 Redux로 관리하던 방식과 비교하면..."
...
:white_check_mark: 올바른 예: `_posts/2026-08-30-react-query-caching.md`
